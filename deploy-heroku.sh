...
# 🚀 ShadowGlass - Script de Despliegue Automático para Heroku
...
# Limpiar cualquier proceso en el puerto 3000
echo "🧹 Limpiando puerto 3000..."
lsof -ti:3000 | xargs kill -9 2>/dev/null || true

# Verificar que node server.js funciona
echo "� Verificando sintaxis del servidor..."
node -c server.js
if [ $? -ne 0 ]; then
    echo "❌ Error: Sintaxis incorrecta en server.js"
    exit 1
fi

echo "✅ Verificación del servidor completada"
